...
namespace PaymentService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<KafkaService>();
            services.AddCors(c => { c.AddPolicy("AllowAll", options => options.AllowAnyOrigin().AllowAnyMethod().AllowAnyHeader()); });
            services.AddControllers();
            services.AddDbContext<PaymentServiceContext>(options => options.UseSqlServer(Configuration["ConnectionStrings:PaymentServiceContext"]));
